...
const columns: { title: string; links: FooterLink[] }[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Oteller", href: "/sektorler/oteller" },
      { label: "Saç Ekimi", href: "/sektorler/sac-ekimi" },
      { label: "Estetik Klinikler", href: "/sektorler/estetik-klinikleri" },
      { label: "Sağlık Turizmi", href: "/sektorler/saglik-turizmi" },
      { label: "Araç Kiralama", href: "/sektorler/arac-kiralama" },
...
function buildSocials(): { icon: React.ReactNode; label: string; href: string }[] {
  const list: { icon: React.ReactNode; label: string; href: string }[] = [
    ...
    },
    {
      ...
      label: "LinkedIn",
      href: "https://www.linkedin.com/company/makicalls/",
    },
    {
