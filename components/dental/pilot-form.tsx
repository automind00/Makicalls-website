          ...
          <div className="bg-[color:var(--color-elevated)] rounded-2xl p-6 md:p-9 shadow-[var(--shadow-md)]">
            {state === "success" ? (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-[color:var(--color-fg)] mb-2">Başvurunuz alındı</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid sm:grid-cols-2 gap-5">
                  <div>
                    <label className="text-xs text-[color:var(--color-fg-muted)] mb-2 block">Adınız Soyadınız</label>
                  ...
                  <div>
                    <label className="text-xs text-[color:var(--color-fg-muted)] mb-2 block">E-posta</label>
                    <div className="relative">
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  <div>
                    <label className="text-xs text-[color:var(--color-fg-muted)] mb-2 block">Telefon</label>
                    <div className="relative">
                  ...
                  <div>
                    <label className="text-xs text-[color:var(--color-fg-muted)] mb-2 block">Klinik adı</label>
                    <div className="relative">
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  <div>
                    <label className="text-xs text-[color:var(--color-fg-muted)] mb-2 block">Semt / İlçe</label>
                    <div className="relative">
                  ...
                  <div>
                    <label className="text-xs text-[color:var(--color-fg-muted)] mb-2 block">Günlük tahmini çağrı</label>
                    <select
                ...
                <div>
                  <label className="text-xs text-[color:var(--color-fg-muted)] mb-2 block">Eklemek istediğiniz</label>
                  <div className="relative">
